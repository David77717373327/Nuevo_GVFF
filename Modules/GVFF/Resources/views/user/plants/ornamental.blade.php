...
@section('title', 'Plantas Ornamentales - GVFF')
@section('content')
    <section class="mt-20" data-aos="fade-up">
        <h2 class="text-3xl font-bold text-green-800 text-center mb-6">Plantas Ornamentales</h2>
        ...
        @else
            <p class="text-gray-600 text-center">No hay plantas ornamentales disponibles en este momento.</p>
        @endif
    </section>
