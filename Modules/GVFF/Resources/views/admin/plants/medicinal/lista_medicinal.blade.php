@extends('gvff::layouts.master')
   ...
   <div class="mb-8">
        <h3 class="text-2xl font-semibold mb-4">Plantas Medicinales</h3>
        @if($plants->where('plant_type', 'medicinal')->isNotEmpty())
            <table class="min-w-full bg-white shadow-md rounded-lg overflow-hidden">
                ...
                <tbody>
                    @foreach($plants->where('plant_type', 'medicinal') as $plant)
        ...
        @else
            <p class="text-gray-600">No hay plantas medicinales registradas.</p>
        @endif
    </div>
