@extends('gvff::layouts.master')
   ...
   @section('content')
    ...
    <div class="mb-8">
        <h3 class="text-2xl font-semibold mb-4">Plantas Ornamentales</h3>
        @if($plants->where('plant_type', 'ornamental')->isNotEmpty())
            <table class="min-w-full bg-white shadow-md rounded-lg overflow-hidden">
                ...
                <tbody>
                    @foreach($plants->where('plant_type', 'ornamental') as $plant)
        ...
        @else
            <p class="text-gray-600">No hay plantas ornamentales registradas.</p>
        @endif
    </div>
    </div>
   @endsection