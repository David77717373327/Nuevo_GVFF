                            ...
                            @forelse ($faunas as $fauna)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form action="{{ route('gvff.admin.faunas.destroy', $fauna) }}" method="POST" style="display:inline;" onsubmit="return confirm('¿Estás seguro de que quieres eliminar esta fauna?');">
                                            @csrf
                                            @method('DELETE')
