...
Route::middleware(['lang'])->group(function () {
        ...
        Route::get('/admin/plant_inventory/sale/get_plants/{id}', action: 'PlantInventoryController@getPlantsByWarehouse')->name('gvff.admin.plant_inventory.sale.getPlantsByWarehouse');
